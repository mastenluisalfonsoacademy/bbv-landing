...
const services = [
  {
    ...
    desc: "1:1-Training individuell auf dich abgestimmt — intensiv, persönlich, effektiv.",
    img: "https://images.unsplash.com/photo-1549060279-7e168fcee0c2?w=600&q=80",
    tag: "1:1 Training",
  },
  {
    title: "Ernährungsplan",
    desc: "Maßgeschneiderter Plan für deine Ziele — wissenschaftlich fundiert und nachhaltig.",
    img: "https://images.unsplash.com/photo-1540497077202-7c8a3999166f?w=600&q=80",
    tag: "Ernährung",
  },
  {
    title: "Online Coaching",
    desc: "Flexible Betreuung von überall — dein persönlicher Coach immer dabei.",
    img: "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=600&q=80",
    tag: "Online",
  },
  {
    title: "Vibrationsplatte",
    desc: "Aktiviert 95% aller Muskelfasern — Fettverbrennung, Kraft, Regeneration.",
    img: "https://images.unsplash.com/photo-1518611012118-696072aa579a?w=600&q=80",
    tag: "Equipment",
  },
  {
    title: "Abnehmen & Form",
    desc: "Nachhaltiger Gewichtsverlust und Körperformung — ohne Jo-Jo-Effekt.",
    img: "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=600&q=80",
    tag: "Transformation",
  },
  {
    title: "Premium Produkte",
    desc: "Von mir persönlich getestet — für maximale Qualität und Ergebnisse.",
    ...
    <motion.div ref={ref}
      ...
      <div className="p-6" style={{ background: "linear-gradient(135deg, #131313, #0f0f0f)" }}>
        ...
        <span className="inline-flex items-center gap-1.5 text-xs font-bold tracking-widest uppercase transition-all duration-300 group-hover:gap-3"
          style={{ color: "#C9A84C" }}>Mehr erfahren →</span>
      </div>
    </motion.div>
  );
}
    ...
    <section id="leistungen" className="py-24 relative">
      ...
      <div className="max-w-7xl mx-auto px-6">
        <motion.div ref={ref} initial={{ opacity: 0, y: 30 }}
          ...
          <p className="text-xs font-bold tracking-[0.35em] uppercase mb-4" style={{ color: "#C9A84C" }}>Was wir anbieten</p>
          ...
          <p className="text-white/40 max-w-lg mx-auto text-sm">
            Ganzheitliche Betreuung für deinen Weg zum Wunschkörper.
          </p>
        </motion.div>
