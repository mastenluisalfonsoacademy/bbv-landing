...
export default function Marquee() {
  return (
    <div className="relative py-5 overflow-hidden border-y" style={{ borderColor: "rgba(0,255,65,0.1)", background: "rgba(0,255,65,0.03)" }}>
      <motion.div animate={{ x: ["0%", "-50%"] }} transition={{ duration: 20, repeat: Infinity, ease: "linear" }}
        className="flex gap-12 whitespace-nowrap" style={{ width: "max-content" }}>
